...
/**
 * Fired during the biome assignment phase of chunk generation.
 *
 ...
 */
public class BiomeAssignmentEvent implements StrataEvent {
    ...
    /**
     * Constructs a new biome assignment event.
     *
     * @param chunkX    the chunk X coordinate
     * @param chunkZ    the chunk Z coordinate
     * @param worldName the name of the world the chunk belongs to
     */
    public BiomeAssignmentEvent(int chunkX, int chunkZ, String worldName) {
        this.chunkX = chunkX;
        this.chunkZ = chunkZ;
