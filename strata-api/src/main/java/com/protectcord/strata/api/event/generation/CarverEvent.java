...
/**
 * Fired during the carving phase of chunk generation (caves, ravines, etc.).
 *
 ...
 */
public class CarverEvent implements StrataEvent {
    ...
    /**
     * Constructs a new carver event.
     *
     * @param chunkX    the chunk X coordinate
     * @param chunkZ    the chunk Z coordinate
     * @param worldName the name of the world the chunk belongs to
     */
    public CarverEvent(int chunkX, int chunkZ, String worldName) {
        this.chunkX = chunkX;
        this.chunkZ = chunkZ;
