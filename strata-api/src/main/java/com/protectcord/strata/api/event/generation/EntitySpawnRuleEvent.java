...
/**
 * Fired during the entity spawn rule evaluation phase of chunk generation.
 *
 ...
 */
public class EntitySpawnRuleEvent implements StrataEvent {
    ...
    /**
     * Constructs a new entity spawn rule event.
     *
     * @param chunkX    the chunk X coordinate
     * @param chunkZ    the chunk Z coordinate
     * @param worldName the name of the world the chunk belongs to
     */
    public EntitySpawnRuleEvent(int chunkX, int chunkZ, String worldName) {
        this.chunkX = chunkX;
        this.chunkZ = chunkZ;
