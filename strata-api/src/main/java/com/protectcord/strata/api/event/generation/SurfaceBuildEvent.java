...
/**
 * Fired during the surface building phase of chunk generation.
 *
 ...
 */
public class SurfaceBuildEvent implements StrataEvent {
    ...
    /**
     * Constructs a new surface build event.
     *
     * @param chunkX    the chunk X coordinate
     * @param chunkZ    the chunk Z coordinate
     * @param worldName the name of the world the chunk belongs to
     */
    public SurfaceBuildEvent(int chunkX, int chunkZ, String worldName) {
        this.chunkX = chunkX;
        this.chunkZ = chunkZ;
