...
/**
 * Fired during the water system placement phase of chunk generation (rivers, lakes, oceans).
 *
 ...
 */
public class WaterSystemEvent implements StrataEvent {
    ...
    /**
     * Constructs a new water system event.
     *
     * @param chunkX    the chunk X coordinate
     * @param chunkZ    the chunk Z coordinate
     * @param worldName the name of the world the chunk belongs to
     */
    public WaterSystemEvent(int chunkX, int chunkZ, String worldName) {
        this.chunkX = chunkX;
        this.chunkZ = chunkZ;
